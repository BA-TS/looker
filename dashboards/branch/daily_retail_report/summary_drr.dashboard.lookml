- dashboard: summary_drr
      ...
      <div style="padding: 20px 0 20px 0; border-radius: 5px; background: #ffe200; height: 80px;">
         ...
         <div style="background: #004f9f; height: 40px; width:100%">
            ...
            <nav style="font-size: 18px;">
               ...
               <a style="color: #ffffff; padding: 0 20px ; float: right; line-height: 40px; font-weight: regular" href="https://tpdev.cloud.looker.com/embed/dashboards-next/148" target="_blank" fullscreen="yes">View Full Screen</a>
              </span>
               <a style="color: #efefef; padding: 0 20px; float: right; line-height: 40px; font-weight: bold; text-decoration: none;"><span style="color: #ffffff;">Daily Sales Report - Branch (Summary)</span></a>
            </nav>
         </div>
  ...
  - name: " (5)"
    ...
    title_text: ''
    subtitle_text: ''
    body_text: "# Year to Date"
    row: 21
    col: 0
    width: 24
    height: 2
  - title: Daily Branch Performance
    name: Daily Branch Performance
    model: ts_sales
    explore: base
    type: looker_grid
    fields: [sites.region_director, sites.head_ofdivision, sites.division, transactions.total_net_sales,
    ...
    sorts: [sites.region_director, base.date_year desc]
    limit: 500
    total: true
    ...
    width: 24
    height: 4
  - title: WTD Branch Performance
    name: WTD Branch Performance
    model: ts_sales
    explore: base
    type: looker_grid
    ...
    filters:
      ...
      base.select_comparison_period: Year
    sorts: [sites.region_director 0, base.date_year desc]
    limit: 500
    total: true
    dynamic_fields: [{category: table_calculation, expression: 'pivot_index(${transactions.total_net_sales},
          1)', label: Actual, value_format: !!null '', value_format_name: gbp_0, _kind_hint: supermeasure,
    ...
    width: 24
    height: 4
  - title: MTD Branch Performance
    name: MTD Branch Performance
    model: ts_sales
    explore: base
    type: looker_grid
    fields: [transactions.total_net_sales, site_budget.site_net_sales_budget, base.date_year,
    ...
    width: 24
    height: 4
  - title: YTD Branch Performance
    name: YTD Branch Performance
    model: ts_sales
    explore: base
    type: looker_grid
    fields: [transactions.total_net_sales, site_budget.site_net_sales_budget, base.date_year,
