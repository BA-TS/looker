- dashboard: digital_daily_sales_report__summary
  ...
  - title: 7 Day Moving Average Trend (Sales)
    ...
    y_axes: [{label: '', orientation: left, series: [{axisId: net_sales, id: This
              ...
              net_sales, name: 2LY}], showLabels: true, showValues: true, maxValue: !!null '',
        minValue: !!null '', valueFormat: '0.0,, "M"', unpinAxis: true, tickDensity: default,
    ...
    defaults_version: 1
    hidden_fields: [transactions.total_net_sales, net_sales_1, net_sales_coalesce]
    note_state: expanded
    note_display: above
  ...
  - title: net_salesdayContribution
    ...
    dynamic_fields: [{category: table_calculation, expression: "${transactions.total_net_sales}\
        ...
        _type_hint: number, is_disabled: true}, {category: table_calculation, expression: "(${transactions.total_net_sales}\
        ...
        _type_hint: number, is_disabled: true}, {category: dimension, expression: 'case(when(${transactions.sales_channel}
          = "WEB" OR ${transactions.sales_channel} = "CLICK & COLLECT" OR ${transactions.sales_channel}
          = "DROPSHIP", yes),no)', label: Digital Sales YN, value_format: !!null '',
        value_format_name: !!null '', dimension: digital_sales_yn, _kind_hint: dimension,
        _type_hint: yesno}, {category: dimension, expression: 'pivot_index(${transactions.total_net_sales},
          2) / (pivot_index(${transactions.total_net_sales}, 1) + pivot_index(${transactions.total_net_sales},
          2))', label: "% Contribution", value_format: !!null '', value_format_name: percent_0,
        dimension: contribution, _kind_hint: dimension, _type_hint: number}, {category: table_calculation,
        expression: 'pivot_index(${transactions.total_net_sales}, 2) / (pivot_index(${transactions.total_net_sales},
          1) + pivot_index(${transactions.total_net_sales}, 2))', label: "% Contribution",
        value_format: !!null '', value_format_name: percent_0, _kind_hint: supermeasure,
        table_calculation: contribution_1, _type_hint: number}]
    custom_color_enabled: true
    show_single_value_title: true
    show_comparison: false
    comparison_type: value
    ...
    color_application:
      collection_id: toolstation
      palette_id: toolstation-categorical-0
    single_value_title: Contribution
    value_format: ''
    ...
    conditional_formatting: [{type: equal to, value: 0, background_color: "#FFE200",
        ...
        value: 0, background_color: "#d32f2f", font_color: !!null '', color_application: {
          collection_id: toolstation, palette_id: toolstation-diverging-0}, bold: false,
        italic: false, strikethrough: false, fields: !!null ''}]
    hidden_fields: [transactions.total_net_sales, base.date_year]
    series_types: {}
    defaults_version: 1
    listen: {}
    row: 5
  ...
  - title: 7 Day Moving Average Trend (AOV)
    ...
    y_axes: [{label: '', orientation: left, series: [{axisId: aov, id: This Year -
        ...
        valueFormat: '0', unpinAxis: true, tickDensity: custom, tickDensityCustom: 18,
        type: linear}]
    limit_displayed_rows_values:
      show_hide: show
      first_last: first
  ...
  - title: Restated Coversion
    ...
    type: looker_line
    fields: [tmp_looker_daily_conversion.transaction_date, tmp_looker_daily_conversion.average_conversion]
    fill_fields: [tmp_looker_daily_conversion.transaction_date]
    filters:
      tmp_looker_daily_conversion.transaction_date: 90 days ago for 90 days
    sorts: [tmp_looker_daily_conversion.transaction_date desc]
    limit: 500
    dynamic_fields: [{category: table_calculation, expression: 'mean(offset_list(${tmp_looker_daily_conversion.average_conversion},0,7))',
        label: 7 Day Average Conversion, value_format: !!null '', value_format_name: !!null '',
        _kind_hint: measure, table_calculation: 7_day_average_conversion, _type_hint: number}]
    x_axis_gridlines: false
    y_axis_gridlines: true
    show_view_names: false
    show_y_axis_labels: true
    ...
    defaults_version: 1
    hidden_fields: [tmp_looker_daily_conversion.average_conversion]
    listen: {}
    row: 25
    col: 0
    width: 24
  ...
  - title: Payment Type
    ...
    explore: base
    type: looker_line
    fields: [base.date_date, transactions.number_of_transactions, transactions.payment_type]
    pivots: [transactions.payment_type]
    filters:
      base.select_date_range: 90 days
      transactions.sales_channel: CLICK & COLLECT,WEB,DROPSHIP
    sorts: [base.date_date desc, transactions.payment_type]
    limit: 500
    dynamic_fields: [{category: table_calculation, expression: 'mean(offset_list(${transactions.number_of_transactions},0,7))',
        label: 7 Day Average transaction count, value_format: !!null '', value_format_name: !!null '',
        _kind_hint: measure, table_calculation: 7_day_average_transaction_count, _type_hint: number}]
    x_axis_gridlines: false
    y_axis_gridlines: true
    show_view_names: false
    show_y_axis_labels: true
    ...
    show_null_points: true
    interpolation: linear
    hidden_fields: [transactions.number_of_transactions]
    defaults_version: 1
    listen: {}
    row: 35
    col: 0
