view: sales_alerts {
  ...
  `toolstation-data-storage.looker_persistent_tables.sales_alerting`
  ...
  measure: net_sales_wow_change {
    ...
    ${net_sales_value} - ${net_sales_wow_value}
  ...
  measure: net_sales_wow_percent {
    ...
    safe_divide(${net_sales_value}, ${net_sales_wow_value}) - 1
  ...
  measure: net_sales_2wow_change {
    ...
    ${net_sales_value} - ${net_sales_2wow_value}
  ...
  measure: net_sales_2wow_percent {
    ...
    safe_divide(${net_sales_value}, ${net_sales_2wow_value}) - 1
  ...
  measure: net_sales_yoy_change {
    ...
    ${net_sales_value} - ${net_sales_yoy_value}
  ...
  measure: net_sales_yoy_percent {
    ...
    safe_divide(${net_sales_value}, ${net_sales_yoy_value}) - 1
  ...
  measure: net_sales_2yoy_change {
    ...
    ${net_sales_value} - ${net_sales_2yoy_value}
  ...
  measure: net_sales_2yoy_percent {
    ...
    safe_divide(${net_sales_value}, ${net_sales_2yoy_value}) - 1
  ...
  measure: wow_flag {
    ...
    if (${net_sales_wow_percent} <= ${deviation_flag}, ${flag} , 0 )
  ...
  measure: 2wow_flag {
    ...
    if (${net_sales_2wow_percent} <= ${deviation_flag}, ${flag} , 0 )
  ...
  measure: yoy_flag {
    ...
    if (${net_sales_yoy_percent} <= ${deviation_flag}, ${flag} , 0 )
  ...
  measure: 2yoy_flag {
    ...
    if (${net_sales_2yoy_percent} <= ${deviation_flag}, ${flag} , 0 )
...
# view: sales_alert_which_is_this {
...
#   measure: net_sales_wow_percentage {
#     type: number
#     sql:
#     ${net_sales_1w_change} / ${net_sales_1w_prior}
#     ;;
#     value_format_name: percent_2
#   }
#   measure: net_sales_2wow_percentage {
#     type: number
#     sql:
#     ${net_sales_2w_change} / ${net_sales_2w_prior}
#     ;;
#     value_format_name: percent_2
#   }
#   measure: net_sales_yoy_percentage {
#     type: number
#     sql:
#     ${net_sales_1y_change} / ${net_sales_1y_prior}
#     ;;
#     value_format_name: percent_2
#   }
...
#     ${net_sales_1w_change} / ${net_sales_1w_prior} <= -{% parameter minimum_deviation %}
#     {% else %}
#     false
#     {% endif %}
...
#     ${net_sales_2w_change} / ${net_sales_2w_prior} <= -{% parameter minimum_deviation %}
#     {% else %}
#     false
#     {% endif %}
...
#     ${net_sales_1y_change} / ${net_sales_1y_prior} <= -{% parameter minimum_deviation %}
#     {% else %}
#     false
#     {% endif %}
