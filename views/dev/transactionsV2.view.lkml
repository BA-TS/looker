...
view: transactionsv2 {
  ...
  dimension: transaction_date_filter {
    ...
    {% if base.select_date_reference._parameter_value == "Placed" %} DATE(${transactionsv2.placed_date}) {% else %} DATE(${transactionsv2.transaction_date}) {% endif %}
...
# ╚═════╝░╚═╝╚═╝░░░░░╚═╝╚══════╝╚═╝░░╚══╝╚═════╝░╚═╝░╚════╝░╚═╝░░╚══╝╚═════╝░
  ...
  dimension: sales_channel {
    ...
    {% if ${transactionsv2.epos_merge} == "1" %}
  ...
  #       AND
  #     ${transactionsv2.transaction_time} > ${trade_credit_details.tc_account_created_time}
