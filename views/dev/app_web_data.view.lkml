  ...
  dimension_group: Placed  {
    ...
    sql: ${TABLE}.Placed ;;
      ...
      {% endif %}"
        ...
        sql: {% if base.select_date_reference._parameter_value == "Placed" %} (${TABLE}.NetSaleValue) * 0.99 {% else %} (${TABLE}.NetSaleValue) {% endif %};;
      }
      ...
      measure: revenue2 {
        ...
        type: sum
        value_format_name: gbp
        sql: {% if base.select_date_reference._parameter_value == "Placed" %} (${TABLE}.revenue2) * 0.99 {% else %} (${TABLE}.revenue2) {% endif %};;
      }
      ...
      measure: AOV {
        ...
        type: number
        value_format_name: gbp
        sql: {% if base.select_date_reference._parameter_value == "Placed" %} ((SUM(${TABLE}.NetSaleValue) * 0.99)/((count(distinct(${TABLE}.OrderID))) * 0.99)) {% else %} (SUM(${TABLE}.NetSaleValue)/(count(distinct(${TABLE}.OrderID)))) {% endif %};;
      ...
      measure: Quantity {
        ...
        sql: {% if base.select_date_reference._parameter_value == "Placed" %} (${TABLE}.Quantity * 0.99) {% else %} (${TABLE}.Quantity) {% endif %};;
      ...
      measure: Total_orders {
        ...
        type: number
        value_format_name: decimal_0
        sql: {% if base.select_date_reference._parameter_value == "Placed" %} (count(distinct ${TABLE}.OrderID) * 0.99) {% else %} (count(distinct ${TABLE}.OrderID)) {% endif %};;
      ...
      measure: marginFunding_perc {
        ...
        sql: {% if base.select_date_reference._parameter_value == "Placed" %} ((sum(${TABLE}.MarginIncFunding) * 0.99)/(SUM(${TABLE}.NetSaleValue) * 0.99)) {% else %} (sum(${TABLE}.MarginIncFunding)/SUM(${TABLE}.NetSaleValue)) {% endif %};;
      ...
      measure: marginfunding_by_order {
        ...
        type: number
        value_format_name: gbp
        sql: {% if base.select_date_reference._parameter_value == "Placed" %} ((sum(${TABLE}.MarginIncFunding) * 0.99)/((count(distinct(${TABLE}.OrderID))) * 0.99)) {% else %} (sum(${TABLE}.MarginIncFunding)/(count(distinct(${TABLE}.OrderID)))) {% endif %};;
      ...
      measure: Total_MarginIncFunding {
        ...
        type: sum
        value_format_name: gbp
        sql: {% if base.select_date_reference._parameter_value == "Placed" %} (${TABLE}.MarginIncFunding * 0.99) {% else %} (${TABLE}.MarginIncFunding) {% endif %};;
      ...
      measure: Total_marginExclFunding {
        ...
        type: sum
        value_format_name: gbp
        sql: {% if base.select_date_reference._parameter_value == "Placed" %} (${TABLE}.MarginExclFunding * 0.99) {% else %} (${TABLE}.MarginExclFunding) {% endif %};;
