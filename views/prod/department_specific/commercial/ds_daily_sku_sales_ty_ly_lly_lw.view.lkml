view: ds_daily_sku_sales_ty_ly_lly_lw {
  ...
  measure: ty_grossSales { type:sum sql:${TABLE}.ty.grossSales;;}
  measure: ty_netSales { type:sum sql:${TABLE}.ty.netSales;;}
  measure: ty_prodMargin { type:sum sql:${TABLE}.ty.prodMargin;;}
  measure: ty_funding { type:sum sql:${TABLE}.ty.funding;;}
  measure: ty_grossMargin { type:sum sql:${TABLE}.ty.grossMargin;;}
  measure: ty_units { type:sum sql:${TABLE}.ty.units;;}
  measure: ty_orders { type:sum sql:${TABLE}.ty.orders;;}
  measure: ty_newProductNetSales { type:sum sql:${TABLE}.ty.newProductNetSales;;}
  measure: ty_newProductMargin { type:sum sql:${TABLE}.ty.newProductMargin;;}
  measure: ty_tradeCreditNetSales { type:sum sql:${TABLE}.ty.tradeCreditNetSales;;}
  measure: ty_tradeCreditMargin { type:sum sql:${TABLE}.ty.tradeCreditMargin;;}
  measure: ty_newCustomerNetSales { type:sum sql:${TABLE}.ty.newCustomerNetSales;;}
  measure: ty_newCustomerMargin { type:sum sql:${TABLE}.ty.newCustomerMargin;;}
  measure: ty_promoNetSales { type:sum sql:${TABLE}.ty.promoNetSales;;}
  measure: ty_promoGrossMargin { type:sum sql:${TABLE}.ty.promoGrossMargin;;}
  measure: ty_isPromo { type:sum sql:${TABLE}.ty.isPromo;;}
  measure: ty_lflNetSales { type:sum sql:${TABLE}.ty.lflNetSales;;}
  measure: ty_lflMargin { type:sum sql:${TABLE}.ty.lflMargin;;}
  measure: ty_lflUnits { type:sum sql:${TABLE}.ty.lflUnits;;}
  measure: ty_BRANCHNetSales { type:sum sql:${TABLE}.ty.BRANCHNetSales;;}
  measure: ty_WEBNetSales { type:sum sql:${TABLE}.ty.WEBNetSales;;}
  measure: ty_CLICKNetSales { type:sum sql:${TABLE}.ty.CLICKNetSales;;}
  measure: ty_EPOSAVNetSales { type:sum sql:${TABLE}.ty.EPOSAVNetSales;;}
  measure: ty_EPOSERNetSales { type:sum sql:${TABLE}.ty.EPOSERNetSales;;}
  measure: ty_CCNetSales { type:sum sql:${TABLE}.ty.CCNetSales;;}
  measure: ty_EBAYNetSales { type:sum sql:${TABLE}.ty.EBAYNetSales;;}
  measure: ty_DROPSHIPNetSales { type:sum sql:${TABLE}.ty.DROPSHIPNetSales;;}
  measure: ty_BRANCHMargin { type:sum sql:${TABLE}.ty.BRANCHMargin;;}
  measure: ty_WEBMargin { type:sum sql:${TABLE}.ty.WEBMargin;;}
  measure: ty_CLICKMargin { type:sum sql:${TABLE}.ty.CLICKMargin;;}
  measure: ty_EPOSAVMargin { type:sum sql:${TABLE}.ty.EPOSAVMargin;;}
  measure: ty_EPOSERMargin { type:sum sql:${TABLE}.ty.EPOSERMargin;;}
  measure: ty_CCMargin { type:sum sql:${TABLE}.ty.CCMargin;;}
  measure: ty_EBAYMargin { type:sum sql:${TABLE}.ty.EBAYMargin;;}
  measure: ty_DROPSHIPMargin { type:sum sql:${TABLE}.ty.DROPSHIPMargin;;}
  measure: ty_netSalesBudget { type:sum sql:${TABLE}.ty.netSalesBudget;;}
  measure: ty_marginBudget { type:sum sql:${TABLE}.ty.marginBudget;;}
  measure: ty_netSalesRF { type:sum sql:${TABLE}.ty.netSalesRF;;}
  measure: ty_marginRF { type:sum sql:${TABLE}.ty.marginRF;;}
  measure: ty_TradeNetSales { type:sum sql:${TABLE}.ty.TradeNetSales;;}
  measure: ty_TradeMargin { type:sum sql:${TABLE}.ty.TradeMargin;;}
  measure: ty_TradeUnits { type:sum sql:${TABLE}.ty.TradeUnits;;}
  measure: ty_TradeParticipation { type:sum sql:${TABLE}.ty.TradeParticipation;;}
  measure: ty_DIYNetSales { type:sum sql:${TABLE}.ty.DIYNetSales;;}
  measure: ty_DIYMargin { type:sum sql:${TABLE}.ty.DIYMargin;;}
  measure: ty_DIYUnits { type:sum sql:${TABLE}.ty.DIYUnits;;}
  measure: ty_DIYParticipation { type:sum sql:${TABLE}.ty.DIYParticipation;;}
  measure: ty_OwnBrandSales { type:sum sql:${TABLE}.ty.OwnBrandSales;;}
  measure: ty_OwnBrandMargin { type:sum sql:${TABLE}.ty.OwnBrandMargin;;}
  measure: ty_OwnBrandUnits { type:sum sql:${TABLE}.ty.OwnBrandUnits;;}
  measure: ty_OwnBrandTradeNetSales { type:sum sql:${TABLE}.ty.OwnBrandTradeNetSales;;}
  measure: ty_OwnBrandTradeMargin { type:sum sql:${TABLE}.ty.OwnBrandTradeMargin;;}
  measure: ty_OwnBrandTradeUnits { type:sum sql:${TABLE}.ty.OwnBrandTradeUnits;;}
  measure: ty_OwnBrandTradeParticipation { type:sum sql:${TABLE}.ty.OwnBrandTradeParticipation;;}
  measure: ty_OwnBrandDIYNetSales { type:sum sql:${TABLE}.ty.OwnBrandDIYNetSales;;}
  measure: ty_OwnBrandDIYMargin { type:sum sql:${TABLE}.ty.OwnBrandDIYMargin;;}
  measure: ty_OwnBrandDIYUnits { type:sum sql:${TABLE}.ty.OwnBrandDIYUnits;;}
  measure: ty_OwnBrandDIYParticipation { type:sum sql:${TABLE}.ty.OwnBrandDIYParticipation;;}
  measure: ly_grossSales { type:sum sql:${TABLE}.ly.grossSales;;}
  measure: ly_netSales { type:sum sql:${TABLE}.ly.netSales;;}
  measure: ly_prodMargin { type:sum sql:${TABLE}.ly.prodMargin;;}
  measure: ly_funding { type:sum sql:${TABLE}.ly.funding;;}
  measure: ly_grossMargin { type:sum sql:${TABLE}.ly.grossMargin;;}
  measure: ly_units { type:sum sql:${TABLE}.ly.units;;}
  measure: ly_orders { type:sum sql:${TABLE}.ly.orders;;}
  measure: ly_newProductNetSales { type:sum sql:${TABLE}.ly.newProductNetSales;;}
  measure: ly_newProductMargin { type:sum sql:${TABLE}.ly.newProductMargin;;}
  measure: ly_tradeCreditNetSales { type:sum sql:${TABLE}.ly.tradeCreditNetSales;;}
  measure: ly_tradeCreditMargin { type:sum sql:${TABLE}.ly.tradeCreditMargin;;}
  measure: ly_newCustomerNetSales { type:sum sql:${TABLE}.ly.newCustomerNetSales;;}
  measure: ly_newCustomerMargin { type:sum sql:${TABLE}.ly.newCustomerMargin;;}
  measure: ly_promoNetSales { type:sum sql:${TABLE}.ly.promoNetSales;;}
  measure: ly_promoGrossMargin { type:sum sql:${TABLE}.ly.promoGrossMargin;;}
  measure: ly_isPromo { type:sum sql:${TABLE}.ly.isPromo;;}
  measure: ly_lflNetSales { type:sum sql:${TABLE}.ly.lflNetSales;;}
  measure: ly_lflMargin { type:sum sql:${TABLE}.ly.lflMargin;;}
  measure: ly_BRANCHNetSales { type:sum sql:${TABLE}.ly.BRANCHNetSales;;}
  measure: ly_WEBNetSales { type:sum sql:${TABLE}.ly.WEBNetSales;;}
  measure: ly_CLICKNetSales { type:sum sql:${TABLE}.ly.CLICKNetSales;;}
  measure: ly_EPOSAVNetSales { type:sum sql:${TABLE}.ly.EPOSAVNetSales;;}
  measure: ly_EPOSERNetSales { type:sum sql:${TABLE}.ly.EPOSERNetSales;;}
  measure: ly_CCNetSales { type:sum sql:${TABLE}.ly.CCNetSales;;}
  measure: ly_EBAYNetSales { type:sum sql:${TABLE}.ly.EBAYNetSales;;}
  measure: ly_DROPSHIPNetSales { type:sum sql:${TABLE}.ly.DROPSHIPNetSales;;}
  measure: ly_BRANCHMargin { type:sum sql:${TABLE}.ly.BRANCHMargin;;}
  measure: ly_WEBMargin { type:sum sql:${TABLE}.ly.WEBMargin;;}
  measure: ly_CLICKMargin { type:sum sql:${TABLE}.ly.CLICKMargin;;}
  measure: ly_EPOSAVMargin { type:sum sql:${TABLE}.ly.EPOSAVMargin;;}
  measure: ly_EPOSERMargin { type:sum sql:${TABLE}.ly.EPOSERMargin;;}
  measure: ly_CCMargin { type:sum sql:${TABLE}.ly.CCMargin;;}
  measure: ly_EBAYMargin { type:sum sql:${TABLE}.ly.EBAYMargin;;}
  measure: ly_DROPSHIPMargin { type:sum sql:${TABLE}.ly.DROPSHIPMargin;;}
  measure: ly_TradeNetSales { type:sum sql:${TABLE}.ly.TradeNetSales;;}
  measure: ly_TradeMargin { type:sum sql:${TABLE}.ly.TradeMargin;;}
  measure: ly_TradeUnits { type:sum sql:${TABLE}.ly.TradeUnits;;}
  measure: ly_TradeParticipation { type:sum sql:${TABLE}.ly.TradeParticipation;;}
  measure: ly_DIYNetSales { type:sum sql:${TABLE}.ly.DIYNetSales;;}
  measure: ly_DIYMargin { type:sum sql:${TABLE}.ly.DIYMargin;;}
  measure: ly_DIYUnits { type:sum sql:${TABLE}.ly.DIYUnits;;}
  measure: ly_DIYParticipation { type:sum sql:${TABLE}.ly.DIYParticipation;;}
  measure: ly_OwnBrandSales { type:sum sql:${TABLE}.ly.OwnBrandSales;;}
  measure: ly_OwnBrandMargin { type:sum sql:${TABLE}.ly.OwnBrandMargin;;}
  measure: ly_OwnBrandUnits { type:sum sql:${TABLE}.ly.OwnBrandUnits;;}
  measure: ly_OwnBrandTradeNetSales { type:sum sql:${TABLE}.ly.OwnBrandTradeNetSales;;}
  measure: ly_OwnBrandTradeMargin { type:sum sql:${TABLE}.ly.OwnBrandTradeMargin;;}
  measure: ly_OwnBrandTradeUnits { type:sum sql:${TABLE}.ly.OwnBrandTradeUnits;;}
  measure: ly_OwnBrandTradeParticipation { type:sum sql:${TABLE}.ly.OwnBrandTradeParticipation;;}
  measure: ly_OwnBrandDIYNetSales { type:sum sql:${TABLE}.ly.OwnBrandDIYNetSales;;}
  measure: ly_OwnBrandDIYMargin { type:sum sql:${TABLE}.ly.OwnBrandDIYMargin;;}
  measure: ly_OwnBrandDIYUnits { type:sum sql:${TABLE}.ly.OwnBrandDIYUnits;;}
  measure: ly_OwnBrandDIYParticipation { type:sum sql:${TABLE}.ly.OwnBrandDIYParticipation;;}
  measure: lly_grossSales { type:sum sql:${TABLE}.lly.grossSales;;}
  measure: lly_netSales { type:sum sql:${TABLE}.lly.netSales;;}
  measure: lly_prodMargin { type:sum sql:${TABLE}.lly.prodMargin;;}
  measure: lly_funding { type:sum sql:${TABLE}.lly.funding;;}
  measure: lly_grossMargin { type:sum sql:${TABLE}.lly.grossMargin;;}
  measure: lly_units { type:sum sql:${TABLE}.lly.units;;}
  measure: lly_newProductNetSales { type:sum sql:${TABLE}.lly.newProductNetSales;;}
  measure: lly_newProductMargin { type:sum sql:${TABLE}.lly.newProductMargin;;}
  measure: lly_tradeCreditNetSales { type:sum sql:${TABLE}.lly.tradeCreditNetSales;;}
  measure: lly_tradeCreditMargin { type:sum sql:${TABLE}.lly.tradeCreditMargin;;}
  measure: lly_newCustomerNetSales { type:sum sql:${TABLE}.lly.newCustomerNetSales;;}
  measure: lly_newCustomerMargin { type:sum sql:${TABLE}.lly.newCustomerMargin;;}
  measure: lly_lflNetSales { type:sum sql:${TABLE}.lly.lflNetSales;;}
  measure: lly_lflMargin { type:sum sql:${TABLE}.lly.lflMargin;;}
  measure: lly_TradeNetSales { type:sum sql:${TABLE}.lly.TradeNetSales;;}
  measure: lly_TradeMargin { type:sum sql:${TABLE}.lly.TradeMargin;;}
  measure: lly_TradeUnits { type:sum sql:${TABLE}.lly.TradeUnits;;}
  measure: lly_TradeParticipation { type:sum sql:${TABLE}.lly.TradeParticipation;;}
  measure: lly_DIYNetSales { type:sum sql:${TABLE}.lly.DIYNetSales;;}
  measure: lly_DIYMargin { type:sum sql:${TABLE}.lly.DIYMargin;;}
  measure: lly_DIYUnits { type:sum sql:${TABLE}.lly.DIYUnits;;}
  measure: lly_DIYParticipation { type:sum sql:${TABLE}.lly.DIYParticipation;;}
  measure: lly_OwnBrandSales { type:sum sql:${TABLE}.lly.OwnBrandSales;;}
  measure: lly_OwnBrandMargin { type:sum sql:${TABLE}.lly.OwnBrandMargin;;}
  measure: lly_OwnBrandUnits { type:sum sql:${TABLE}.lly.OwnBrandUnits;;}
  measure: lly_OwnBrandTradeNetSales { type:sum sql:${TABLE}.lly.OwnBrandTradeNetSales;;}
  measure: lly_OwnBrandTradeMargin { type:sum sql:${TABLE}.lly.OwnBrandTradeMargin;;}
  measure: lly_OwnBrandTradeUnits { type:sum sql:${TABLE}.lly.OwnBrandTradeUnits;;}
  measure: lly_OwnBrandTradeParticipation { type:sum sql:${TABLE}.lly.OwnBrandTradeParticipation;;}
  measure: lly_OwnBrandDIYNetSales { type:sum sql:${TABLE}.lly.OwnBrandDIYNetSales;;}
  measure: lly_OwnBrandDIYMargin { type:sum sql:${TABLE}.lly.OwnBrandDIYMargin;;}
  measure: lly_OwnBrandDIYUnits { type:sum sql:${TABLE}.lly.OwnBrandDIYUnits;;}
  measure: lly_OwnBrandDIYParticipation { type:sum sql:${TABLE}.lly.OwnBrandDIYParticipation;;}
  measure: lw_grossSales { type:sum sql:${TABLE}.lw.grossSales;;}
  measure: lw_netSales { type:sum sql:${TABLE}.lw.netSales;;}
  measure: lw_prodMargin { type:sum sql:${TABLE}.lw.prodMargin;;}
  measure: lw_funding { type:sum sql:${TABLE}.lw.funding;;}
  measure: lw_grossMargin { type:sum sql:${TABLE}.lw.grossMargin;;}
  measure: lw_units { type:sum sql:${TABLE}.lw.units;;}
  measure: lw_newProductNetSales { type:sum sql:${TABLE}.lw.newProductNetSales;;}
  measure: lw_newProductMargin { type:sum sql:${TABLE}.lw.newProductMargin;;}
  measure: lw_tradeCreditNetSales { type:sum sql:${TABLE}.lw.tradeCreditNetSales;;}
  measure: lw_tradeCreditMargin { type:sum sql:${TABLE}.lw.tradeCreditMargin;;}
  measure: lw_newCustomerNetSales { type:sum sql:${TABLE}.lw.newCustomerNetSales;;}
  measure: lw_newCustomerMargin { type:sum sql:${TABLE}.lw.newCustomerMargin;;}
  measure: lw_lflNetSales { type:sum sql:${TABLE}.lw.lflNetSales;;}
  measure: lw_lflMargin { type:sum sql:${TABLE}.lw.lflMargin;;}
  measure: lw_TradeNetSales { type:sum sql:${TABLE}.lw.TradeNetSales;;}
  measure: lw_TradeMargin { type:sum sql:${TABLE}.lw.TradeMargin;;}
  measure: lw_TradeUnits { type:sum sql:${TABLE}.lw.TradeUnits;;}
  measure: lw_TradeParticipation { type:sum sql:${TABLE}.lw.TradeParticipation;;}
  measure: lw_DIYNetSales { type:sum sql:${TABLE}.lw.DIYNetSales;;}
  measure: lw_DIYMargin { type:sum sql:${TABLE}.lw.DIYMargin;;}
  measure: lw_DIYUnits { type:sum sql:${TABLE}.lw.DIYUnits;;}
  measure: lw_DIYParticipation { type:sum sql:${TABLE}.lw.DIYParticipation;;}
  measure: lw_OwnBrandSales { type:sum sql:${TABLE}.lw.OwnBrandSales;;}
  measure: lw_OwnBrandMargin { type:sum sql:${TABLE}.lw.OwnBrandMargin;;}
  measure: lw_OwnBrandUnits { type:sum sql:${TABLE}.lw.OwnBrandUnits;;}
  measure: lw_OwnBrandTradeNetSales { type:sum sql:${TABLE}.lw.OwnBrandTradeNetSales;;}
  measure: lw_OwnBrandTradeMargin { type:sum sql:${TABLE}.lw.OwnBrandTradeMargin;;}
  measure: lw_OwnBrandTradeUnits { type:sum sql:${TABLE}.lw.OwnBrandTradeUnits;;}
  measure: lw_OwnBrandTradeParticipation { type:sum sql:${TABLE}.lw.OwnBrandTradeParticipation;;}
  measure: lw_OwnBrandDIYNetSales { type:sum sql:${TABLE}.lw.OwnBrandDIYNetSales;;}
  measure: lw_OwnBrandDIYMargin { type:sum sql:${TABLE}.lw.OwnBrandDIYMargin;;}
  measure: lw_OwnBrandDIYUnits { type:sum sql:${TABLE}.lw.OwnBrandDIYUnits;;}
  measure: lw_OwnBrandDIYParticipation { type:sum sql:${TABLE}.lw.OwnBrandDIYParticipation;;}
}
