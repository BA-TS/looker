...
# Scores  --------------------------------------------------------------------
  ...
  dimension: pillarTotalColleague {group_label: "Ranking" type:string value_format_name:decimal_3 sql:${TABLE}.pillarTotalColleague;;hidden:no}
  dimension: pillarTotalSimplicityEfficiency {group_label: "Ranking" type:string value_format_name:decimal_3 sql:${TABLE}.pillarTotalSimplicityEfficiency;;hidden:no}
  dimension: pillarTotalCust {group_label: "Ranking" type:string value_format_name:decimal_3 sql:${TABLE}.pillarTotalCust;;hidden:no}
  dimension: pillarTotalOverall {group_label: "Ranking" type:string value_format_name:decimal_3 sql:${TABLE}.pillarTotalOverall;;hidden:no}
