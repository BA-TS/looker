...
# Scores  --------------------------------------------------------------------
  ...
  dimension: overallRank_error_flag {group_label:"Error Flags" type:number sql:case when (${overallRank_dim} is null) then 1 else 0 end;;}
  dimension: ColleagueRag_error_flag {group_label:"Error Flags" type:number sql:case when (${ColleagueRag_dim} is null) then 1 else 0 end;;}
  dimension: SimplicityEfficiencyRag_error_flag {group_label:"Error Flags" type:number sql:case when (${SimplicityEfficiencyRag_dim} is null) then 1 else 0 end;;}
  dimension: CustRag_error_flag {group_label:"Error Flags" type:number sql:case when (${CustRag_dim} is null) then 1 else 0 end;;}
  dimension: OverallRag_error_flag {group_label:"Error Flags" type:number sql:case when (${OverallRag_dim} is null) then 1 else 0 end;;}
