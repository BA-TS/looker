...
case when page_location is null then concat(case
when Screen_name like "%| Search |%" then "search-page"
else screen_name
end, aw.item_id) else page_location end as page_location,
case
when Screen_name like "%| Search |%" then "search-page"
else screen_name
end as screen,
...
from Page
left join ATC on page.page_session_id = ATC.atc_session_id and page.screen = ATC.screen
