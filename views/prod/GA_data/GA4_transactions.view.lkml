view: ga4_transactions {
  ...
  #}
    ...
    type: string
    hidden: yes
    sql: concat(coalesce(transaction_PK,concat(${ga4_rjagdev_test.PK}, ${TABLE}.OrderID, ${TABLE}.item_id)), coalesce(${ga4_rjagdev_test.session_id},"NONE"), coalesce(${ga4_rjagdev_test.Mintime},"NONE"),cast(${offset} as string)) ;;
  }
