...
explore: GA4_testy {
  ...
  join: ga4_transactions {
    ...
    relationship: one_to_one
    sql_where: ${ga4_transactions.OrderID} not in ("(not set)") and ((${ga4_rjagdev_test.itemid}=${ga4_transactions.item_id}) or (${ga4_rjagdev_test.itemid} is not null and ${ga4_transactions.item_id} is null) or (${ga4_rjagdev_test.itemid}=${ga4_transactions.item_id}) or (${ga4_rjagdev_test.itemid} is null and ${ga4_transactions.item_id} is null)) ;;
  }
