...
#{% endif %} ;;
  ...
  join: ga4_landingpage {
    type: left_outer
    relationship: many_to_one
    sql_on: ${ga4_rjagdev_test.session_id} = ${ga4_landingpage.land_session} and ${calendar_completed_date.date} = ${ga4_landingpage.date_date} and ${ga4_rjagdev_test.page_location} = ${ga4_landingpage.land_page};;
  ...
  join: ga4_exitpage {
    type: left_outer
    relationship: many_to_one
    sql_on: ${ga4_rjagdev_test.session_id} = ${ga4_exitpage.exit_session} and ${calendar_completed_date.date} = ${ga4_exitpage.date_date} and ${ga4_rjagdev_test.page_location} = ${ga4_exitpage.exit_page};;
  ...
  join: search_purchase {
    ...
    type: left_outer
    relationship: many_to_one
    sql_on: ${calendar_completed_date.date} = ${search_purchase.search_date_date};;
    #sql_where: ${ga4_exitpage.LastE} = 1;;
  }
  ...
  join: recommend_purchase {
    ...
    type: left_outer
    relationship: many_to_one
    sql_on: ${calendar_completed_date.date} = ${recommend_purchase.recommend_date_date} and ${products.product_code} = ${recommend_purchase.item_id};;
  ...
  join: suggested_byprovider_purchase {
    ...
    type: left_outer
    relationship: many_to_one
    sql_on: ${calendar_completed_date.date} = ${suggested_byprovider_purchase.suggest_viewdate_date} and ${products.product_code} = coalesce(${suggested_byprovider_purchase.sku}, "null") ;;
  }
