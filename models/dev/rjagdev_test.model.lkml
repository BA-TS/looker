...
#{% endif %} ;;
  ...
  join: ga4_rjagdev_test {
    ...
    or
    ga4_rjagdev_test._TABLE_SUFFIX BETWEEN coalesce(FORMAT_DATE('%Y%m%d', {% date_start calendar.filter_on_field_to_hide2 %}), "00000000") and coalesce(FORMAT_DATE('%Y%m%d', {% date_end calendar.filter_on_field_to_hide2 %}), "00000000")
    )
